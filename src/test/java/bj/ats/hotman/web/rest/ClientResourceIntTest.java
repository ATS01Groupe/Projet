...
import bj.ats.hotman.repository.ClientRepository;
import bj.ats.hotman.service.ClientService;
import bj.ats.hotman.repository.search.ClientSearchRepository;
...
public class ClientResourceIntTest {
    ...
    private static final String DEFAULT_CARTNUMENBER = "AAAAAAAAAA";
    private static final String UPDATED_CARTNUMENBER = "BBBBBBBBBB";
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client()
            ...
            .cartnumenber(DEFAULT_CARTNUMENBER)
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getFistname()).isEqualTo(DEFAULT_FISTNAME);
        assertThat(testClient.getLastname()).isEqualTo(DEFAULT_LASTNAME);
        assertThat(testClient.getCartnumenber()).isEqualTo(DEFAULT_CARTNUMENBER);
    ...
    @Test
    @Transactional
    public void checkCartnumenberIsRequired() throws Exception {
        int databaseSizeBeforeTest = clientRepository.findAll().size();
        // set the field null
        client.setCartnumenber(null);
    ...
    public void getAllClients() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cartnumenber").value(hasItem(DEFAULT_CARTNUMENBER.toString())))
    ...
    public void getClient() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients/{id}", client.getId()))
            ...
            .andExpect(jsonPath("$.cartnumenber").value(DEFAULT_CARTNUMENBER.toString()))
    ...
    public void updateClient() throws Exception {
        ...
        updatedClient
            ...
            .cartnumenber(UPDATED_CARTNUMENBER)
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getFistname()).isEqualTo(UPDATED_FISTNAME);
        assertThat(testClient.getLastname()).isEqualTo(UPDATED_LASTNAME);
        assertThat(testClient.getCartnumenber()).isEqualTo(UPDATED_CARTNUMENBER);
